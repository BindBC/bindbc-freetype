...
static if(staticBinding){
	extern(C) nothrow @nogc{
		...
		FT_Error FT_Stroker_GetBorderCounts(FT_Stroker stroker, FT_StrokerBorder border, uint* anum_points, uint* anum_contours);
		void FT_Stroker_ExportBorder(FT_Stroker stroker, FT_StrokerBorder border, FT_Outline* outline);
		FT_Error FT_Stroker_GetCounts(FT_Stroker stroker, uint* anum_points, uint* anum_contours);
	...
	extern(C) nothrow @nogc{
		...
		alias pFT_Stroker_GetBorderCounts = FT_Error function(FT_Stroker stroker, FT_StrokerBorder border, uint* anum_points, uint* anum_contours);
		alias pFT_Stroker_ExportBorder = void function(FT_Stroker stroker, FT_StrokerBorder border, FT_Outline* outline);
		alias pFT_Stroker_GetCounts = FT_Error function(FT_Stroker stroker, uint* anum_points, uint* anum_contours);
