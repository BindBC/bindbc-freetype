...
FTSupport loadFreeType(const(char)* libName){
	...
	else loadedVersion = FTSupport.v2_6;
	...
	static if(ftSupport >= FTSupport.v2_7){
		...
		if(errorCount() != errCount) return FTSupport.badLibrary;
		else loadedVersion = FTSupport.v2_7;
	}
	static if(ftSupport >= FTSupport.v2_8){
		...
		if(errorCount() != errCount) return FTSupport.badLibrary;
		else loadedVersion = FTSupport.v2_8;
	}
	static if(ftSupport >= FTSupport.v2_9){
		...
		if(errorCount() != errCount) return FTSupport.badLibrary;
		else loadedVersion = FTSupport.v2_9;
	}
	static if(ftSupport >= FTSupport.v2_10){
		...
		if(errorCount() != errCount) return FTSupport.badLibrary;
		else loadedVersion = FTSupport.v2_10;
	}
	static if(ftSupport >= FTSupport.v2_11){
		...
		if(errorCount() != errCount) return FTSupport.badLibrary;
		else loadedVersion = FTSupport.v2_11;
	}
